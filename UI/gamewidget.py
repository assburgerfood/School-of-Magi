...
class Ui_main_game(object):
    def setupUi(self, main_game):
        ...
        self.label_time = QtWidgets.QLabel(self.character_frame)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.char_box.addWidget(self.label_time)
...
"color: rgb(0, 0, 0);")
        ...
        self.char_box.setStretch(2, 1)
        self.char_box.setStretch(6, 13)
    ...
    def retranslateUi(self, main_game):
        ...
        self.label_time.setText(_translate("main_game", "time"))
